...
<html>
    ...
    <body>
     <div class="container">
            ...
            <div class="btn " style="margin-bottom:3px;float:right;background-color:#303030">
            ...
            <span style="float:left">Login UserName:{{ Auth::user()->name }}</span>
        <br />
     ...
     $(document).on('click', '.edit', function(){
      ...
      $.ajax({
       ...
       success:function(html){
        ...
        $('#parent_name').val(html.data.parent_name);
        $('#address').val(html.data.address);
        $('#email').val(html.data.email);
        $('#phone').val(html.data.mobile);
